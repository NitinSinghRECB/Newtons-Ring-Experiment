                ...
                <div class="simulation-grid">
                    <div class="simulation-controls">
                        ...
                        <img id="lightImage" src="light.png" alt="Light On" style="display: none; position: absolute; top: 50px; left: 50px;">
                            ...
                            <button class="btn btn-primary" id="lightOn">Light On
                            </button>   
                            <div class="slide-container"> Microscope Position
    <input type="range" id="slider" min="0" max="100" value="0">
</div>
<div class="slider-container"><center>
    <label for="radiusSlider">Radius of Curvature:</label><br>
    <input type="range" id="radiusSlider" min="1" max="100" value="50" oninput="updateRadiusValue(this.value)">
    <span id="radiusValue">50</span>Nm
  </div>

  <div class="slider-container"><center>
    <label for="microscopeSlider">Microscope Focus:</label><br>
    <input type="range" id="microscopeSlider" min="1" max="100" value="50" oninput="updateMicroscopeValue(this.value)">
    <span id="microscopeValue">50</span> Nm
  </div>


  
  <button class="btn btn-primary" onclick="displayValue()">Result</button>
...
<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 612 792">
  ...
  <circle class="st0" cx="306" cy="269.33" r="7.01"/>
    ...
    showResults() {
        ...
        const microscopeFocus = document.getElementById('microscopeSlider').value;
    
        // Example calculation logic
        const result = this.calculateResult(radius, microscopeFocus);
    ...
    calculateResult(radius, microscopeFocus) {
        // Implement the logic to calculate results based on parameters
        // Example: result = radius * microscopeFocus / 100
        const result = (radius * microscopeFocus) / 100;
        return result;
    }
